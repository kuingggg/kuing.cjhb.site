...
for (let item of tikzs) {
    ...
    item.innerHTML = '<div class="jiaz"></div><img src="https://i.upmath.me/svg/'+str_for_link+'" onclick="show_tikz_window(\''+str_for_show+'\');" onload="this.parentNode.classList.add(\'jiazed\')" />';
}
